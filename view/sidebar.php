...
<aside class="sidebar">
  ...
  <a href="<?= $root ?>view/admin_dashboard.php" class="nav-item<?= ($activePage ?? '') === 'dashboard' ? ' active' : '' ?>" data-page="dashboard">
    <span class="nav-icon">
  ...
  <a href="<?= $root ?>view/admin_admission.php" class="nav-item<?= ($activePage ?? '') === 'admission' ? ' active' : '' ?>" data-page="admission">
    <span class="nav-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
          viewBox="0 0 24 24" fill="currentColor">
        <path d="M0 0h24v24H0z" fill="none"/>
  ...
  <a href="<?= $root ?>view/admin_enrollment.php" class="nav-item<?= ($activePage ?? '') === 'enrollment' ? ' active' : '' ?>" data-page="enrollment">
    <span class="nav-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
  ...
  <nav class="nav-section">
    ...
    <a href="<?= $root ?>view/manage_user.php" class="nav-item<?= ($activePage ?? '') === 'manage_user' ? ' active' : '' ?>" data-page="manage_user">
      <span class="nav-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
            viewBox="0 0 24 24" fill="currentColor">
          <path d="M0 0h24v24H0z" fill="none"/>
    ...
    <a href="<?= $root ?>view/courses.php" class="nav-item<?= ($activePage ?? '') === 'courses' ? ' active' : '' ?>" data-page="courses">
      <span class="nav-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
            viewBox="0 0 24 24" fill="currentColor">
          <path d="M0 0h24v24H0z" fill="none"/>
    ...
    <a href="<?= $root ?>view/schedule.php" class="nav-item<?= ($activePage ?? '') === 'schedule' ? ' active' : '' ?>" data-page="schedule">
      <span class="nav-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
            viewBox="0 0 24 24" fill="currentColor">
          <path d="M0 0h24v24H0z" fill="none"/>
  ...
  <nav class="nav-section">
    ...
    <a href="<?= $root ?>view/revenue.php" class="nav-item<?= ($activePage ?? '') === 'revenue' ? ' active' : '' ?>" data-page="revenue">
      <span class="nav-icon">
    ...
    <a href="<?= $root ?>view/total_enrolees.php" 
