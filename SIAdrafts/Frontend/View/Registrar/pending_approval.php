  ...
  <main class="page-content">
    ...
    <div class="sched-page-header">
      <div>
        ...
        <p class="sched-page-sub">Courses, sections, subjects, and schedules submitted by Registrar Staff, waiting for your decision.</p>
      </div>
    </div>
    ...
    <div class="panel-stack">
      ...
      <div class="panel">
        <div class="panel-header">
          ...
          <span class="text-muted" style="font-size:12px;" id="pendingCourseCount"></span>
        </div>
        <div class="panel-body" style="padding:0">
          <div class="table-responsive">
          <table class="data-table" id="pendingCourseTable">
            <thead>
              <tr>
                <th>Submitted By</th>
                <th>Code</th>
      ...
      <div class="panel">
        <div class="panel-header">
          ...
          <span class="text-muted" style="font-size:12px;" id="pendingSectionCount"></span>
        </div>
        <div class="panel-body" style="padding:0">
          <div class="table-responsive">
          <table class="data-table" id="pendingSectionTable">
            <thead>
              <tr>
                <th>Submitted By</th>
                <th>Section</th>
      ...
      <div class="panel">
        <div class="panel-header">
          <span class="panel-title">Pending Subjects</span>
          <span class="text-muted" style="font-size:12px;" id="pendingSubjectCount"></span>
        </div>
        <div class="panel-body" style="padding:0">
          <div class="table-responsive">
          <table class="data-table" id="pendingSubjectTable">
            <thead>
              <tr>
                <th>Submitted By</th>
                <th>Code</th>
            ...
            <tbody id="pendingSubjectBody"></tbody>
          </table>
          </div>
      ...
      <div class="panel">
        <div class="panel-header">
          ...
          <span class="text-muted" style="font-size:12px;" id="pendingScheduleCount"></span>
        </div>
        <div class="panel-body" style="padding:0">
          <div class="table-responsive">
