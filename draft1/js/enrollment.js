// Enrollment search page Vue app (enrollment.php)
  ...
  Vue.createApp({
    ...
    methods: {
      ...
      async doSearch() {
        ...
        try {
          const r = await fetch(
            `api/get_student.php?q=${encodeURIComponent(this.query)}&mode=${mode}`
          );
      ...
      submitSearch() {
        ...
        window.location.href =
          `enrollment_profile.php?q=${encodeURIComponent(this.query)}&mode=${mode}`;
      },
    },
  }).mount('#enroll-app');
}
